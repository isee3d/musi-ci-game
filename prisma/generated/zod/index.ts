...
export const GameScalarFieldEnumSchema = z.enum(['id','name','description','color']);

export const LevelScalarFieldEnumSchema = z.enum(['id','id_Game','name','description','color']);
...
export const QuestionAnswerScalarFieldEnumSchema = z.enum(['id','id_User','question','answer','answeredDate']);

export const QuestionScalarFieldEnumSchema = z.enum(['id','id_subLevel','question']);

export const ActivityScalarFieldEnumSchema = z.enum(['id','id_User','activity','activity_Date']);
...
export type UserRelations = {
  ...
  questionAnswers: QuestionAnswerWithRelations[];
...
export const UserWithRelationsSchema: z.ZodType<UserWithRelations> = UserSchema.merge(z.object({
  ...
  questionAnswers: z.lazy(() => QuestionAnswerWithRelationsSchema).array(),
  activities: z.lazy(() => ActivityWithRelationsSchema).array(),
}))
...
export type UserOptionalDefaultsRelations = {
  ...
  questionAnswers: QuestionAnswerOptionalDefaultsWithRelations[];
  activities: ActivityOptionalDefaultsWithRelations[];
};
...
export const UserOptionalDefaultsWithRelationsSchema: z.ZodType<UserOptionalDefaultsWithRelations> = UserOptionalDefaultsSchema.merge(z.object({
  ...
  questionAnswers: z.lazy(() => QuestionAnswerOptionalDefaultsWithRelationsSchema).array(),
  activities: z.lazy(() => ActivityOptionalDefaultsWithRelationsSchema).array(),
}))
...
export type FragmentRelations = {
  ...
  chosenScene: SceneWithRelations[];
...
export const FragmentWithRelationsSchema: z.ZodType<FragmentWithRelations> = FragmentSchema.merge(z.object({
  ...
  chosenScene: z.lazy(() => SceneWithRelationsSchema).array(),
...
export type FragmentOptionalDefaultsRelations = {
  ...
  chosenScene: SceneOptionalDefaultsWithRelations[];
...
export const FragmentOptionalDefaultsWithRelationsSchema: z.ZodType<FragmentOptionalDefaultsWithRelations> = FragmentOptionalDefaultsSchema.merge(z.object({
  ...
  chosenScene: z.lazy(() => SceneOptionalDefaultsWithRelationsSchema).array(),
...
export const SceneSchema = z.object({
  ...
  id_playedFragment: z.number().int().nullish(),
  chosenFragmentLatency: z.number().int().nullish(),
  answeredCorrectly: z.boolean().nullish(),
})
...
export type SceneRelations = {
  ...
  playedFragment?: FragmentWithRelations | null;
};
...
export const SceneWithRelationsSchema: z.ZodType<SceneWithRelations> = SceneSchema.merge(z.object({
  ...
  playedFragment: z.lazy(() => FragmentWithRelationsSchema).nullish(),
}))
...
export type SceneOptionalDefaultsRelations = {
  ...
  playedFragment?: FragmentOptionalDefaultsWithRelations | null;
};
...
export const SceneOptionalDefaultsWithRelationsSchema: z.ZodType<SceneOptionalDefaultsWithRelations> = SceneOptionalDefaultsSchema.merge(z.object({
  ...
  playedFragment: z.lazy(() => FragmentOptionalDefaultsWithRelationsSchema).nullish(),
}))
...
export const SceneFragmentSchema = z.object({
  ...
  id_fragment: z.number().int(),
  fragmentIndex: z.number().int(),
  groundTone: z.number().int(),
})
...
export const QuestionAnswerSchema = z.object({
  ...
  question: z.string(),
  answer: z.string(),
  answeredDate: z.coerce.date(),
})

export type QuestionAnswer = z.infer<typeof QuestionAnswerSchema>

// QUESTION ANSWER OPTIONAL DEFAULTS SCHEMA
//------------------------------------------------------

export const QuestionAnswerOptionalDefaultsSchema = QuestionAnswerSchema.merge(z.object({
  id: z.number().int().optional(),
  answeredDate: z.coerce.date().optional(),
}))

export type QuestionAnswerOptionalDefaults = z.infer<typeof QuestionAnswerOptionalDefaultsSchema>

// QUESTION ANSWER RELATION SCHEMA
//------------------------------------------------------

export type QuestionAnswerRelations = {
  user?: UserWithRelations | null;
};

export type QuestionAnswerWithRelations = z.infer<typeof QuestionAnswerSchema> & QuestionAnswerRelations

export const QuestionAnswerWithRelationsSchema: z.ZodType<QuestionAnswerWithRelations> = QuestionAnswerSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema).nullish(),
}))

// QUESTION ANSWER OPTIONAL DEFAULTS RELATION SCHEMA
//------------------------------------------------------

export type QuestionAnswerOptionalDefaultsRelations = {
  user?: UserOptionalDefaultsWithRelations | null;
};

export type QuestionAnswerOptionalDefaultsWithRelations = z.infer<typeof QuestionAnswerOptionalDefaultsSchema> & QuestionAnswerOptionalDefaultsRelations

export const QuestionAnswerOptionalDefaultsWithRelationsSchema: z.ZodType<QuestionAnswerOptionalDefaultsWithRelations> = QuestionAnswerOptionalDefaultsSchema.merge(z.object({
  user: z.lazy(() => UserOptionalDefaultsWithRelationsSchema).nullish(),
}))
...
export const UserIncludeSchema: z.ZodType<Prisma.UserInclude> = z.object({
  ...
  questionAnswers: z.union([z.boolean(),z.lazy(() => QuestionAnswerFindManyArgsSchema)]).optional(),
...
export const UserCountOutputTypeSelectSchema: z.ZodType<Prisma.UserCountOutputTypeSelect> = z.object({
  ...
  questionAnswers: z.boolean().optional(),
...
export const SubLevelCountOutputTypeSelectSchema: z.ZodType<Prisma.SubLevelCountOutputTypeSelect> = z.object({
  ...
  fragmentGroups: z.boolean().optional(),
}).strict();
...
export const FragmentIncludeSchema: z.ZodType<Prisma.FragmentInclude> = z.object({
  ...
  chosenScene: z.union([z.boolean(),z.lazy(() => SceneFindManyArgsSchema)]).optional(),
...
export const FragmentCountOutputTypeSelectSchema: z.ZodType<Prisma.FragmentCountOutputTypeSelect> = z.object({
  ...
  chosenScene: z.boolean().optional(),
  playedScene: z.boolean().optional(),
  relistenfragment: z.boolean().optional(),
  sceneFragment: z.boolean().optional(),
  fragmentgroup: z.boolean().optional(),
}).strict();
...
export const SceneIncludeSchema: z.ZodType<Prisma.SceneInclude> = z.object({
  ...
  playedFragment: z.union([z.boolean(),z.lazy(() => FragmentArgsSchema)]).optional(),
...
export const SceneSelectSchema: z.ZodType<Prisma.SceneSelect> = z.object({
  ...
  id_playedFragment: z.boolean().optional(),
...
export const QuestionAnswerIncludeSchema: z.ZodType<Prisma.QuestionAnswerInclude> = z.object({
  user: z.union([z.boolean(),z.lazy(() => UserArgsSchema)]).optional(),
}).strict()

export const QuestionAnswerArgsSchema: z.ZodType<Prisma.QuestionAnswerArgs> = z.object({
  select: z.lazy(() => QuestionAnswerSelectSchema).optional(),
  include: z.lazy(() => QuestionAnswerIncludeSchema).optional(),
}).strict();

export const QuestionAnswerSelectSchema: z.ZodType<Prisma.QuestionAnswerSelect> = z.object({
  id: z.boolean().optional(),
  id_User: z.boolean().optional(),
  question: z.boolean().optional(),
  answer: z.boolean().optional(),
  answeredDate: z.boolean().optional(),
  user: z.union([z.boolean(),z.lazy(() => UserArgsSchema)]).optional(),
}).strict()
...
export const QuestionArgsSchema: z.ZodType<Prisma.QuestionArgs> = z.object({
...
export const ActivityArgsSchema: z.ZodType<Prisma.ActivityArgs> = z.object({
...
export const ActivitySelectSchema: z.ZodType<Prisma.ActivitySelect> = z.object({
  ...
  activity_Date: z.boolean().optional(),
  user: z.union([z.boolean(),z.lazy(() => UserArgsSchema)]).optional(),
}).strict()
...
export const UserWhereInputSchema: z.ZodType<Prisma.UserWhereInput> = z.object({
  ...
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  participantId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export const UserScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.UserScalarWhereWithAggregatesInput> = z.object({
  ...
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  participantId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
...
export const FragmentWhereInputSchema: z.ZodType<Prisma.FragmentWhereInput> = z.object({
  ...
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  useAlways: z.union([ z.lazy(() => BoolNullableFilterSchema),z.boolean() ]).optional().nullable(),
  notes: z.lazy(() => NoteListRelationFilterSchema).optional(),
  level: z.lazy(() => SubLevelListRelationFilterSchema).optional(),
  chosenScene: z.lazy(() => SceneListRelationFilterSchema).optional(),
...
export const FragmentOrderByWithRelationInputSchema: z.ZodType<Prisma.FragmentOrderByWithRelationInput> = z.object({
  ...
  name: z.lazy(() => SortOrderSchema).optional(),
  description: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  useAlways: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const FragmentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.FragmentScalarWhereWithAggregatesInput> = z.object({
  ...
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  useAlways: z.union([ z.lazy(() => BoolNullableWithAggregatesFilterSchema),z.boolean() ]).optional().nullable(),
}).strict();
...
export const GameModeWhereInputSchema: z.ZodType<Prisma.GameModeWhereInput> = z.object({
  ...
  go: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
...
export const GameModeScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.GameModeScalarWhereWithAggregatesInput> = z.object({
  ...
  go: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
}).strict();
...
export const SceneWhereInputSchema: z.ZodType<Prisma.SceneWhereInput> = z.object({
  ...
  id_playedFragment: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  ...
  playedFragment: z.union([ z.lazy(() => FragmentRelationFilterSchema),z.lazy(() => FragmentWhereInputSchema) ]).optional().nullable(),
}).strict();
...
export const SceneOrderByWithRelationInputSchema: z.ZodType<Prisma.SceneOrderByWithRelationInput> = z.object({
  ...
  playedFragment: z.lazy(() => FragmentOrderByWithRelationInputSchema).optional()
}).strict();
...
export const SceneScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SceneScalarWhereWithAggregatesInput> = z.object({
  ...
  id_playedFragment: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  chosenFragmentLatency: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  answeredCorrectly: z.union([ z.lazy(() => BoolNullableWithAggregatesFilterSchema),z.boolean() ]).optional().nullable(),
}).strict();
...
export const SceneFragmentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SceneFragmentScalarWhereWithAggregatesInput> = z.object({
  ...
  id_fragment: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  fragmentIndex: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  groundTone: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
}).strict();
...
export const QuestionAnswerWhereInputSchema: z.ZodType<Prisma.QuestionAnswerWhereInput> = z.object({
  AND: z.union([ z.lazy(() => QuestionAnswerWhereInputSchema),z.lazy(() => QuestionAnswerWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => QuestionAnswerWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => QuestionAnswerWhereInputSchema),z.lazy(() => QuestionAnswerWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  id_User: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
export const QuestionAnswerOrderByWithAggregationInputSchema: z.ZodType<Prisma.QuestionAnswerOrderByWithAggregationInput> = z.object({
  ...
  _min: z.lazy(() => QuestionAnswerMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => QuestionAnswerSumOrderByAggregateInputSchema).optional()
}).strict();

export const QuestionAnswerScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.QuestionAnswerScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => QuestionAnswerScalarWhereWithAggregatesInputSchema),z.lazy(() => QuestionAnswerScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => QuestionAnswerScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => QuestionAnswerScalarWhereWithAggregatesInputSchema),z.lazy(() => QuestionAnswerScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  id_User: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
...
export const ActivityScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ActivityScalarWhereWithAggregatesInput> = z.object({
  ...
  id: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  id_User: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  activity: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  activity_Date: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
}).strict();
...
export const UserCreateInputSchema: z.ZodType<Prisma.UserCreateInput> = z.object({
  ...
  questionAnswers: z.lazy(() => QuestionAnswerCreateNestedManyWithoutUserInputSchema).optional(),
...
export const UserUncheckedCreateInputSchema: z.ZodType<Prisma.UserUncheckedCreateInput> = z.object({
  ...
  questionAnswers: z.lazy(() => QuestionAnswerUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  activities: z.lazy(() => ActivityUncheckedCreateNestedManyWithoutUserInputSchema).optional()
}).strict();

export const UserUpdateInputSchema: z.ZodType<Prisma.UserUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  participantId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  questionAnswers: z.lazy(() => QuestionAnswerUpdateManyWithoutUserNestedInputSchema).optional(),
...
export const UserUncheckedUpdateInputSchema: z.ZodType<Prisma.UserUncheckedUpdateInput> = z.object({
  ...
  questionAnswers: z.lazy(() => QuestionAnswerUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
...
export const FragmentCreateInputSchema: z.ZodType<Prisma.FragmentCreateInput> = z.object({
  name: z.string(),
  description: z.string().optional().nullable(),
  useAlways: z.boolean().optional().nullable(),
...
export const FragmentUpdateInputSchema: z.ZodType<Prisma.FragmentUpdateInput> = z.object({
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  useAlways: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const GameModeCreateInputSchema: z.ZodType<Prisma.GameModeCreateInput> = z.object({
  ...
  go: z.number().int().optional().nullable(),
...
export const GameModeUpdateInputSchema: z.ZodType<Prisma.GameModeUpdateInput> = z.object({
  ...
  go: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SceneCreateInputSchema: z.ZodType<Prisma.SceneCreateInput> = z.object({
  ...
  answeredCorrectly: z.boolean().optional().nullable(),
  chosenFragment: z.lazy(() => FragmentCreateNestedOneWithoutChosenSceneInputSchema).optional(),
  ...
  playedFragment: z.lazy(() => FragmentCreateNestedOneWithoutPlayedSceneInputSchema).optional()
}).strict();
...
export const SceneUncheckedCreateInputSchema: z.ZodType<Prisma.SceneUncheckedCreateInput> = z.object({
  ...
  id_playedFragment: z.number().int().optional().nullable(),
  chosenFragmentLatency: z.number().int().optional().nullable(),
  answeredCorrectly: z.boolean().optional().nullable(),
...
export const SceneUpdateInputSchema: z.ZodType<Prisma.SceneUpdateInput> = z.object({
  ...
  answeredCorrectly: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  chosenFragment: z.lazy(() => FragmentUpdateOneWithoutChosenSceneNestedInputSchema).optional(),
  ...
  playedFragment: z.lazy(() => FragmentUpdateOneWithoutPlayedSceneNestedInputSchema).optional()
}).strict();
...
export const SceneUncheckedUpdateInputSchema: z.ZodType<Prisma.SceneUncheckedUpdateInput> = z.object({
  ...
  id_playedFragment: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  chosenFragmentLatency: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  answeredCorrectly: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SceneFragmentUpdateInputSchema: z.ZodType<Prisma.SceneFragmentUpdateInput> = z.object({
  fragmentIndex: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const QuestionAnswerUncheckedCreateInputSchema: z.ZodType<Prisma.QuestionAnswerUncheckedCreateInput> = z.object({
  id: z.number().int().optional(),
  id_User: z.string(),
  question: z.string(),
  answer: z.string(),
...
export const QuestionAnswerUncheckedUpdateInputSchema: z.ZodType<Prisma.QuestionAnswerUncheckedUpdateInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  id_User: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  question: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  answer: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const QuestionCreateInputSchema: z.ZodType<Prisma.QuestionCreateInput> = z.object({
  question: z.string(),
  subLevel: z.lazy(() => SubLevelCreateNestedOneWithoutQuestionsInputSchema).optional()
}).strict();
...
export const QuestionUpdateInputSchema: z.ZodType<Prisma.QuestionUpdateInput> = z.object({
  question: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  subLevel: z.lazy(() => SubLevelUpdateOneWithoutQuestionsNestedInputSchema).optional()
}).strict();
...
export const ActivityCreateInputSchema: z.ZodType<Prisma.ActivityCreateInput> = z.object({
  activity: z.string(),
  activity_Date: z.coerce.date().optional(),
  user: z.lazy(() => UserCreateNestedOneWithoutActivitiesInputSchema).optional()
}).strict();
...
export const ActivityUpdateInputSchema: z.ZodType<Prisma.ActivityUpdateInput> = z.object({
  activity: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  activity_Date: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  user: z.lazy(() => UserUpdateOneWithoutActivitiesNestedInputSchema).optional()
}).strict();
...
export const QuestionAnswerListRelationFilterSchema: z.ZodType<Prisma.QuestionAnswerListRelationFilter> = z.object({
  every: z.lazy(() => QuestionAnswerWhereInputSchema).optional(),
  some: z.lazy(() => QuestionAnswerWhereInputSchema).optional(),
  none: z.lazy(() => QuestionAnswerWhereInputSchema).optional()
}).strict();
...
export const QuestionAnswerOrderByRelationAggregateInputSchema: z.ZodType<Prisma.QuestionAnswerOrderByRelationAggregateInput> = z.object({
  _count: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const FragmentCountOrderByAggregateInputSchema: z.ZodType<Prisma.FragmentCountOrderByAggregateInput> = z.object({
  ...
  name: z.lazy(() => SortOrderSchema).optional(),
  description: z.lazy(() => SortOrderSchema).optional(),
  useAlways: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const QuestionAnswerAvgOrderByAggregateInputSchema: z.ZodType<Prisma.QuestionAnswerAvgOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional()
}).strict();

export const QuestionAnswerMaxOrderByAggregateInputSchema: z.ZodType<Prisma.QuestionAnswerMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  id_User: z.lazy(() => SortOrderSchema).optional(),
  question: z.lazy(() => SortOrderSchema).optional(),
  answer: z.lazy(() => SortOrderSchema).optional(),
...
export const QuestionAnswerMinOrderByAggregateInputSchema: z.ZodType<Prisma.QuestionAnswerMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  id_User: z.lazy(() => SortOrderSchema).optional(),
  question: z.lazy(() => SortOrderSchema).optional(),
  answer: z.lazy(() => SortOrderSchema).optional(),
...
export const QuestionAnswerSumOrderByAggregateInputSchema: z.ZodType<Prisma.QuestionAnswerSumOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const QuestionAnswerCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.QuestionAnswerCreateNestedManyWithoutUserInput> = z.object({
  create: z.union([ z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema).array(),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const QuestionAnswerUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.QuestionAnswerUncheckedCreateNestedManyWithoutUserInput> = z.object({
  create: z.union([ z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema).array(),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const QuestionAnswerUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.QuestionAnswerUpdateManyWithoutUserNestedInput> = z.object({
  create: z.union([ z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema).array(),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => QuestionAnswerUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => QuestionAnswerUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => QuestionAnswerUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => QuestionAnswerUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => QuestionAnswerUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => QuestionAnswerUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => QuestionAnswerScalarWhereInputSchema),z.lazy(() => QuestionAnswerScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const QuestionAnswerUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.QuestionAnswerUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  create: z.union([ z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema).array(),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema),z.lazy(() => QuestionAnswerCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => QuestionAnswerUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => QuestionAnswerUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => QuestionAnswerWhereUniqueInputSchema),z.lazy(() => QuestionAnswerWhereUniqueInputSchema).array() ]).optional(),
...
export const QuestionCreateNestedManyWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionCreateNestedManyWithoutSubLevelInput> = z.object({
  create: z.union([ z.lazy(() => QuestionCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateWithoutSubLevelInputSchema).array(),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema).array() ]).optional(),
...
export const QuestionUncheckedCreateNestedManyWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUncheckedCreateNestedManyWithoutSubLevelInput> = z.object({
  create: z.union([ z.lazy(() => QuestionCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateWithoutSubLevelInputSchema).array(),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => QuestionWhereUniqueInputSchema),z.lazy(() => QuestionWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const QuestionUpdateManyWithoutSubLevelNestedInputSchema: z.ZodType<Prisma.QuestionUpdateManyWithoutSubLevelNestedInput> = z.object({
  create: z.union([ z.lazy(() => QuestionCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateWithoutSubLevelInputSchema).array(),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => QuestionUpsertWithWhereUniqueWithoutSubLevelInputSchema),z.lazy(() => QuestionUpsertWithWhereUniqueWithoutSubLevelInputSchema).array() ]).optional(),
  ...
  connect: z.union([ z.lazy(() => QuestionWhereUniqueInputSchema),z.lazy(() => QuestionWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => QuestionUpdateWithWhereUniqueWithoutSubLevelInputSchema),z.lazy(() => QuestionUpdateWithWhereUniqueWithoutSubLevelInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => QuestionUpdateManyWithWhereWithoutSubLevelInputSchema),z.lazy(() => QuestionUpdateManyWithWhereWithoutSubLevelInputSchema).array() ]).optional(),
...
export const QuestionUncheckedUpdateManyWithoutSubLevelNestedInputSchema: z.ZodType<Prisma.QuestionUncheckedUpdateManyWithoutSubLevelNestedInput> = z.object({
  create: z.union([ z.lazy(() => QuestionCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateWithoutSubLevelInputSchema).array(),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema),z.lazy(() => QuestionCreateOrConnectWithoutSubLevelInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => QuestionUpsertWithWhereUniqueWithoutSubLevelInputSchema),z.lazy(() => QuestionUpsertWithWhereUniqueWithoutSubLevelInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => QuestionWhereUniqueInputSchema),z.lazy(() => QuestionWhereUniqueInputSchema).array() ]).optional(),
...
export const FragmentCreateNestedManyWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentCreateNestedManyWithoutFragmentgroupInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema).array(),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const SubLevelCreateNestedManyWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelCreateNestedManyWithoutFragmentGroupsInput> = z.object({
  create: z.union([ z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema).array(),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const FragmentUncheckedCreateNestedManyWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUncheckedCreateNestedManyWithoutFragmentgroupInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema).array(),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const SubLevelUncheckedCreateNestedManyWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUncheckedCreateNestedManyWithoutFragmentGroupsInput> = z.object({
  create: z.union([ z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema).array(),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const FragmentUpdateManyWithoutFragmentgroupNestedInputSchema: z.ZodType<Prisma.FragmentUpdateManyWithoutFragmentgroupNestedInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema).array(),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => FragmentUpsertWithWhereUniqueWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUpsertWithWhereUniqueWithoutFragmentgroupInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => FragmentUpdateWithWhereUniqueWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUpdateWithWhereUniqueWithoutFragmentgroupInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => FragmentUpdateManyWithWhereWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUpdateManyWithWhereWithoutFragmentgroupInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => FragmentScalarWhereInputSchema),z.lazy(() => FragmentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const SubLevelUpdateManyWithoutFragmentGroupsNestedInputSchema: z.ZodType<Prisma.SubLevelUpdateManyWithoutFragmentGroupsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema).array(),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubLevelUpsertWithWhereUniqueWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUpsertWithWhereUniqueWithoutFragmentGroupsInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => SubLevelUpdateWithWhereUniqueWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUpdateWithWhereUniqueWithoutFragmentGroupsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SubLevelUpdateManyWithWhereWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUpdateManyWithWhereWithoutFragmentGroupsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SubLevelScalarWhereInputSchema),z.lazy(() => SubLevelScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const FragmentUncheckedUpdateManyWithoutFragmentgroupNestedInputSchema: z.ZodType<Prisma.FragmentUncheckedUpdateManyWithoutFragmentgroupNestedInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema).array(),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema),z.lazy(() => FragmentCreateOrConnectWithoutFragmentgroupInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => FragmentUpsertWithWhereUniqueWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUpsertWithWhereUniqueWithoutFragmentgroupInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => FragmentWhereUniqueInputSchema),z.lazy(() => FragmentWhereUniqueInputSchema).array() ]).optional(),
...
export const SubLevelUncheckedUpdateManyWithoutFragmentGroupsNestedInputSchema: z.ZodType<Prisma.SubLevelUncheckedUpdateManyWithoutFragmentGroupsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema).array(),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubLevelUpsertWithWhereUniqueWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUpsertWithWhereUniqueWithoutFragmentGroupsInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => SubLevelWhereUniqueInputSchema),z.lazy(() => SubLevelWhereUniqueInputSchema).array() ]).optional(),
...
export const SceneCreateNestedManyWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneCreateNestedManyWithoutPlayedFragmentInput> = z.object({
  create: z.union([ z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema).array(),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const SceneUncheckedCreateNestedManyWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUncheckedCreateNestedManyWithoutPlayedFragmentInput> = z.object({
  create: z.union([ z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema).array(),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const SceneUpdateManyWithoutPlayedFragmentNestedInputSchema: z.ZodType<Prisma.SceneUpdateManyWithoutPlayedFragmentNestedInput> = z.object({
  create: z.union([ z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema).array(),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SceneUpsertWithWhereUniqueWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUpsertWithWhereUniqueWithoutPlayedFragmentInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => SceneUpdateWithWhereUniqueWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUpdateWithWhereUniqueWithoutPlayedFragmentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SceneUpdateManyWithWhereWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUpdateManyWithWhereWithoutPlayedFragmentInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SceneScalarWhereInputSchema),z.lazy(() => SceneScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const SceneUncheckedUpdateManyWithoutPlayedFragmentNestedInputSchema: z.ZodType<Prisma.SceneUncheckedUpdateManyWithoutPlayedFragmentNestedInput> = z.object({
  create: z.union([ z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema).array(),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema),z.lazy(() => SceneCreateOrConnectWithoutPlayedFragmentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SceneUpsertWithWhereUniqueWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUpsertWithWhereUniqueWithoutPlayedFragmentInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => SceneWhereUniqueInputSchema),z.lazy(() => SceneWhereUniqueInputSchema).array() ]).optional(),
...
export const FragmentCreateNestedOneWithoutChosenSceneInputSchema: z.ZodType<Prisma.FragmentCreateNestedOneWithoutChosenSceneInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutChosenSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutChosenSceneInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => FragmentCreateOrConnectWithoutChosenSceneInputSchema).optional(),
  connect: z.lazy(() => FragmentWhereUniqueInputSchema).optional()
}).strict();
...
export const FragmentCreateNestedOneWithoutPlayedSceneInputSchema: z.ZodType<Prisma.FragmentCreateNestedOneWithoutPlayedSceneInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutPlayedSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutPlayedSceneInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => FragmentCreateOrConnectWithoutPlayedSceneInputSchema).optional(),
  connect: z.lazy(() => FragmentWhereUniqueInputSchema).optional()
}).strict();
...
export const FragmentUpdateOneWithoutChosenSceneNestedInputSchema: z.ZodType<Prisma.FragmentUpdateOneWithoutChosenSceneNestedInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutChosenSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutChosenSceneInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => FragmentCreateOrConnectWithoutChosenSceneInputSchema).optional(),
  upsert: z.lazy(() => FragmentUpsertWithoutChosenSceneInputSchema).optional(),
  disconnect: z.boolean().optional(),
  delete: z.boolean().optional(),
  connect: z.lazy(() => FragmentWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => FragmentUpdateWithoutChosenSceneInputSchema),z.lazy(() => FragmentUncheckedUpdateWithoutChosenSceneInputSchema) ]).optional(),
}).strict();
...
export const FragmentUpdateOneWithoutPlayedSceneNestedInputSchema: z.ZodType<Prisma.FragmentUpdateOneWithoutPlayedSceneNestedInput> = z.object({
  create: z.union([ z.lazy(() => FragmentCreateWithoutPlayedSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutPlayedSceneInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => FragmentCreateOrConnectWithoutPlayedSceneInputSchema).optional(),
  upsert: z.lazy(() => FragmentUpsertWithoutPlayedSceneInputSchema).optional(),
  disconnect: z.boolean().optional(),
  delete: z.boolean().optional(),
  connect: z.lazy(() => FragmentWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => FragmentUpdateWithoutPlayedSceneInputSchema),z.lazy(() => FragmentUncheckedUpdateWithoutPlayedSceneInputSchema) ]).optional(),
}).strict();
...
export const UserCreateNestedOneWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutQuestionAnswersInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutQuestionAnswersInputSchema),z.lazy(() => UserUncheckedCreateWithoutQuestionAnswersInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutQuestionAnswersInputSchema).optional(),
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional()
}).strict();

export const UserUpdateOneWithoutQuestionAnswersNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutQuestionAnswersNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutQuestionAnswersInputSchema),z.lazy(() => UserUncheckedCreateWithoutQuestionAnswersInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutQuestionAnswersInputSchema).optional(),
  upsert: z.lazy(() => UserUpsertWithoutQuestionAnswersInputSchema).optional(),
  disconnect: z.boolean().optional(),
  delete: z.boolean().optional(),
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => UserUpdateWithoutQuestionAnswersInputSchema),z.lazy(() => UserUncheckedUpdateWithoutQuestionAnswersInputSchema) ]).optional(),
}).strict();

export const SubLevelCreateNestedOneWithoutQuestionsInputSchema: z.ZodType<Prisma.SubLevelCreateNestedOneWithoutQuestionsInput> = z.object({
  create: z.union([ z.lazy(() => SubLevelCreateWithoutQuestionsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutQuestionsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SubLevelCreateOrConnectWithoutQuestionsInputSchema).optional(),
  connect: z.lazy(() => SubLevelWhereUniqueInputSchema).optional()
}).strict();

export const SubLevelUpdateOneWithoutQuestionsNestedInputSchema: z.ZodType<Prisma.SubLevelUpdateOneWithoutQuestionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubLevelCreateWithoutQuestionsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutQuestionsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SubLevelCreateOrConnectWithoutQuestionsInputSchema).optional(),
  upsert: z.lazy(() => SubLevelUpsertWithoutQuestionsInputSchema).optional(),
  disconnect: z.boolean().optional(),
  delete: z.boolean().optional(),
  connect: z.lazy(() => SubLevelWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SubLevelUpdateWithoutQuestionsInputSchema),z.lazy(() => SubLevelUncheckedUpdateWithoutQuestionsInputSchema) ]).optional(),
}).strict();
...
export const UserUpdateOneWithoutActivitiesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutActivitiesNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutActivitiesInputSchema),z.lazy(() => UserUncheckedCreateWithoutActivitiesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutActivitiesInputSchema).optional(),
  ...
  delete: z.boolean().optional(),
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => UserUpdateWithoutActivitiesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutActivitiesInputSchema) ]).optional(),
}).strict();
...
export const QuestionAnswerCreateOrConnectWithoutUserInputSchema: z.ZodType<Prisma.QuestionAnswerCreateOrConnectWithoutUserInput> = z.object({
  where: z.lazy(() => QuestionAnswerWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
...
export const QuestionAnswerUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.QuestionAnswerUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => QuestionAnswerWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => QuestionAnswerUpdateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => QuestionAnswerCreateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedCreateWithoutUserInputSchema) ]),
}).strict();

export const QuestionAnswerUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.QuestionAnswerUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => QuestionAnswerWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => QuestionAnswerUpdateWithoutUserInputSchema),z.lazy(() => QuestionAnswerUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();

export const QuestionAnswerUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.QuestionAnswerUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => QuestionAnswerScalarWhereInputSchema),
  data: z.union([ z.lazy(() => QuestionAnswerUpdateManyMutationInputSchema),z.lazy(() => QuestionAnswerUncheckedUpdateManyWithoutQuestionAnswersInputSchema) ]),
}).strict();

export const QuestionAnswerScalarWhereInputSchema: z.ZodType<Prisma.QuestionAnswerScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => QuestionAnswerScalarWhereInputSchema),z.lazy(() => QuestionAnswerScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => QuestionAnswerScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => QuestionAnswerScalarWhereInputSchema),z.lazy(() => QuestionAnswerScalarWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  id_User: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  question: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  answer: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
export const ActivityUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.ActivityUpdateManyWithWhereWithoutUserInput> = z.object({
  ...
  data: z.union([ z.lazy(() => ActivityUpdateManyMutationInputSchema),z.lazy(() => ActivityUncheckedUpdateManyWithoutActivitiesInputSchema) ]),
}).strict();
...
export const QuestionCreateWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionCreateWithoutSubLevelInput> = z.object({
  question: z.string()
}).strict();

export const QuestionUncheckedCreateWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUncheckedCreateWithoutSubLevelInput> = z.object({
  id: z.number().int().optional(),
  question: z.string()
}).strict();

export const QuestionCreateOrConnectWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionCreateOrConnectWithoutSubLevelInput> = z.object({
...
export const QuestionUpsertWithWhereUniqueWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUpsertWithWhereUniqueWithoutSubLevelInput> = z.object({
  where: z.lazy(() => QuestionWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => QuestionUpdateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedUpdateWithoutSubLevelInputSchema) ]),
  create: z.union([ z.lazy(() => QuestionCreateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedCreateWithoutSubLevelInputSchema) ]),
}).strict();

export const QuestionUpdateWithWhereUniqueWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUpdateWithWhereUniqueWithoutSubLevelInput> = z.object({
  where: z.lazy(() => QuestionWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => QuestionUpdateWithoutSubLevelInputSchema),z.lazy(() => QuestionUncheckedUpdateWithoutSubLevelInputSchema) ]),
}).strict();

export const QuestionUpdateManyWithWhereWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUpdateManyWithWhereWithoutSubLevelInput> = z.object({
  where: z.lazy(() => QuestionScalarWhereInputSchema),
  data: z.union([ z.lazy(() => QuestionUpdateManyMutationInputSchema),z.lazy(() => QuestionUncheckedUpdateManyWithoutQuestionsInputSchema) ]),
}).strict();
...
export const FragmentCreateWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentCreateWithoutFragmentgroupInput> = z.object({
  name: z.string(),
  description: z.string().optional().nullable(),
  useAlways: z.boolean().optional().nullable(),
  notes: z.lazy(() => NoteCreateNestedManyWithoutFragmentInputSchema).optional(),
...
export const FragmentUncheckedCreateWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUncheckedCreateWithoutFragmentgroupInput> = z.object({
  id: z.number().int().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  useAlways: z.boolean().optional().nullable(),
...
export const FragmentCreateOrConnectWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentCreateOrConnectWithoutFragmentgroupInput> = z.object({
  where: z.lazy(() => FragmentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema) ]),
}).strict();

export const SubLevelCreateWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelCreateWithoutFragmentGroupsInput> = z.object({
  name: z.string(),
  description: z.string().optional().nullable(),
  cooldownTime: z.number().int().optional().nullable(),
  playTime: z.number().int().optional().nullable(),
...
export const SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUncheckedCreateWithoutFragmentGroupsInput> = z.object({
  id: z.number().int().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  cooldownTime: z.number().int().optional().nullable(),
...
export const SubLevelCreateOrConnectWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelCreateOrConnectWithoutFragmentGroupsInput> = z.object({
  where: z.lazy(() => SubLevelWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema) ]),
}).strict();

export const FragmentUpsertWithWhereUniqueWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUpsertWithWhereUniqueWithoutFragmentgroupInput> = z.object({
  where: z.lazy(() => FragmentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => FragmentUpdateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedUpdateWithoutFragmentgroupInputSchema) ]),
  create: z.union([ z.lazy(() => FragmentCreateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutFragmentgroupInputSchema) ]),
}).strict();

export const FragmentUpdateWithWhereUniqueWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUpdateWithWhereUniqueWithoutFragmentgroupInput> = z.object({
  where: z.lazy(() => FragmentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => FragmentUpdateWithoutFragmentgroupInputSchema),z.lazy(() => FragmentUncheckedUpdateWithoutFragmentgroupInputSchema) ]),
}).strict();

export const FragmentUpdateManyWithWhereWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUpdateManyWithWhereWithoutFragmentgroupInput> = z.object({
  where: z.lazy(() => FragmentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => FragmentUpdateManyMutationInputSchema),z.lazy(() => FragmentUncheckedUpdateManyWithoutFragmentsInputSchema) ]),
}).strict();

export const SubLevelUpsertWithWhereUniqueWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUpsertWithWhereUniqueWithoutFragmentGroupsInput> = z.object({
  where: z.lazy(() => SubLevelWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SubLevelUpdateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedUpdateWithoutFragmentGroupsInputSchema) ]),
  create: z.union([ z.lazy(() => SubLevelCreateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutFragmentGroupsInputSchema) ]),
}).strict();

export const SubLevelUpdateWithWhereUniqueWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUpdateWithWhereUniqueWithoutFragmentGroupsInput> = z.object({
  where: z.lazy(() => SubLevelWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SubLevelUpdateWithoutFragmentGroupsInputSchema),z.lazy(() => SubLevelUncheckedUpdateWithoutFragmentGroupsInputSchema) ]),
}).strict();

export const SubLevelUpdateManyWithWhereWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUpdateManyWithWhereWithoutFragmentGroupsInput> = z.object({
  where: z.lazy(() => SubLevelScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SubLevelUpdateManyMutationInputSchema),z.lazy(() => SubLevelUncheckedUpdateManyWithoutSubLevelsInputSchema) ]),
}).strict();
...
export const SceneCreateWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneCreateWithoutPlayedFragmentInput> = z.object({
  chosenFragmentLatency: z.number().int().optional().nullable(),
  answeredCorrectly: z.boolean().optional().nullable(),
  chosenFragment: z.lazy(() => FragmentCreateNestedOneWithoutChosenSceneInputSchema).optional(),
  sceneFragments: z.lazy(() => SceneFragmentCreateNestedManyWithoutSceneInputSchema).optional(),
...
export const SceneUncheckedCreateWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUncheckedCreateWithoutPlayedFragmentInput> = z.object({
  id: z.number().int().optional(),
  id_chosenFragment: z.number().int().optional().nullable(),
  id_levelResult: z.number().int().optional().nullable(),
  chosenFragmentLatency: z.number().int().optional().nullable(),
...
export const SceneCreateOrConnectWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneCreateOrConnectWithoutPlayedFragmentInput> = z.object({
  where: z.lazy(() => SceneWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema) ]),
}).strict();
...
export const SceneUpdateManyWithWhereWithoutChosenFragmentInputSchema: z.ZodType<Prisma.SceneUpdateManyWithWhereWithoutChosenFragmentInput> = z.object({
  ...
  data: z.union([ z.lazy(() => SceneUpdateManyMutationInputSchema),z.lazy(() => SceneUncheckedUpdateManyWithoutChosenSceneInputSchema) ]),
}).strict();
...
export const SceneUpsertWithWhereUniqueWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUpsertWithWhereUniqueWithoutPlayedFragmentInput> = z.object({
  where: z.lazy(() => SceneWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SceneUpdateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedUpdateWithoutPlayedFragmentInputSchema) ]),
  create: z.union([ z.lazy(() => SceneCreateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedCreateWithoutPlayedFragmentInputSchema) ]),
}).strict();

export const SceneUpdateWithWhereUniqueWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUpdateWithWhereUniqueWithoutPlayedFragmentInput> = z.object({
  where: z.lazy(() => SceneWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SceneUpdateWithoutPlayedFragmentInputSchema),z.lazy(() => SceneUncheckedUpdateWithoutPlayedFragmentInputSchema) ]),
}).strict();

export const SceneUpdateManyWithWhereWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUpdateManyWithWhereWithoutPlayedFragmentInput> = z.object({
  where: z.lazy(() => SceneScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SceneUpdateManyMutationInputSchema),z.lazy(() => SceneUncheckedUpdateManyWithoutPlayedSceneInputSchema) ]),
}).strict();
...
export const FragmentCreateWithoutChosenSceneInputSchema: z.ZodType<Prisma.FragmentCreateWithoutChosenSceneInput> = z.object({
  name: z.string(),
  description: z.string().optional().nullable(),
  useAlways: z.boolean().optional().nullable(),
  notes: z.lazy(() => NoteCreateNestedManyWithoutFragmentInputSchema).optional(),
...
export const FragmentCreateOrConnectWithoutChosenSceneInputSchema: z.ZodType<Prisma.FragmentCreateOrConnectWithoutChosenSceneInput> = z.object({
  where: z.lazy(() => FragmentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => FragmentCreateWithoutChosenSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutChosenSceneInputSchema) ]),
}).strict();
...
export const FragmentCreateWithoutPlayedSceneInputSchema: z.ZodType<Prisma.FragmentCreateWithoutPlayedSceneInput> = z.object({
  name: z.string(),
  description: z.string().optional().nullable(),
  useAlways: z.boolean().optional().nullable(),
  notes: z.lazy(() => NoteCreateNestedManyWithoutFragmentInputSchema).optional(),
...
export const FragmentCreateOrConnectWithoutPlayedSceneInputSchema: z.ZodType<Prisma.FragmentCreateOrConnectWithoutPlayedSceneInput> = z.object({
  where: z.lazy(() => FragmentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => FragmentCreateWithoutPlayedSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutPlayedSceneInputSchema) ]),
}).strict();

export const FragmentUpsertWithoutChosenSceneInputSchema: z.ZodType<Prisma.FragmentUpsertWithoutChosenSceneInput> = z.object({
  update: z.union([ z.lazy(() => FragmentUpdateWithoutChosenSceneInputSchema),z.lazy(() => FragmentUncheckedUpdateWithoutChosenSceneInputSchema) ]),
  create: z.union([ z.lazy(() => FragmentCreateWithoutChosenSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutChosenSceneInputSchema) ]),
}).strict();

export const FragmentUpdateWithoutChosenSceneInputSchema: z.ZodType<Prisma.FragmentUpdateWithoutChosenSceneInput> = z.object({
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  useAlways: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  notes: z.lazy(() => NoteUpdateManyWithoutFragmentNestedInputSchema).optional(),
...
export const FragmentUpsertWithoutPlayedSceneInputSchema: z.ZodType<Prisma.FragmentUpsertWithoutPlayedSceneInput> = z.object({
  update: z.union([ z.lazy(() => FragmentUpdateWithoutPlayedSceneInputSchema),z.lazy(() => FragmentUncheckedUpdateWithoutPlayedSceneInputSchema) ]),
  create: z.union([ z.lazy(() => FragmentCreateWithoutPlayedSceneInputSchema),z.lazy(() => FragmentUncheckedCreateWithoutPlayedSceneInputSchema) ]),
}).strict();

export const FragmentUpdateWithoutPlayedSceneInputSchema: z.ZodType<Prisma.FragmentUpdateWithoutPlayedSceneInput> = z.object({
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  useAlways: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  notes: z.lazy(() => NoteUpdateManyWithoutFragmentNestedInputSchema).optional(),
...
export const UserCreateWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserCreateWithoutQuestionAnswersInput> = z.object({
  id: z.string().cuid().optional(),
  participantId: z.string().optional().nullable(),
  name: z.string().optional().nullable(),
  email: z.string().optional().nullable(),
...
export const UserUncheckedCreateWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutQuestionAnswersInput> = z.object({
  id: z.string().cuid().optional(),
  participantId: z.string().optional().nullable(),
  name: z.string().optional().nullable(),
  email: z.string().optional().nullable(),
...
export const UserCreateOrConnectWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutQuestionAnswersInput> = z.object({
  where: z.lazy(() => UserWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => UserCreateWithoutQuestionAnswersInputSchema),z.lazy(() => UserUncheckedCreateWithoutQuestionAnswersInputSchema) ]),
}).strict();

export const UserUpsertWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserUpsertWithoutQuestionAnswersInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutQuestionAnswersInputSchema),z.lazy(() => UserUncheckedUpdateWithoutQuestionAnswersInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutQuestionAnswersInputSchema),z.lazy(() => UserUncheckedCreateWithoutQuestionAnswersInputSchema) ]),
}).strict();

export const UserUpdateWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserUpdateWithoutQuestionAnswersInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  participantId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  name: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  email: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const UserUncheckedUpdateWithoutQuestionAnswersInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutQuestionAnswersInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  participantId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  name: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  email: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SubLevelCreateWithoutQuestionsInputSchema: z.ZodType<Prisma.SubLevelCreateWithoutQuestionsInput> = z.object({
  name: z.string(),
  description: z.string().optional().nullable(),
  cooldownTime: z.number().int().optional().nullable(),
  playTime: z.number().int().optional().nullable(),
...
export const SubLevelCreateOrConnectWithoutQuestionsInputSchema: z.ZodType<Prisma.SubLevelCreateOrConnectWithoutQuestionsInput> = z.object({
  where: z.lazy(() => SubLevelWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubLevelCreateWithoutQuestionsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutQuestionsInputSchema) ]),
}).strict();

export const SubLevelUpsertWithoutQuestionsInputSchema: z.ZodType<Prisma.SubLevelUpsertWithoutQuestionsInput> = z.object({
  update: z.union([ z.lazy(() => SubLevelUpdateWithoutQuestionsInputSchema),z.lazy(() => SubLevelUncheckedUpdateWithoutQuestionsInputSchema) ]),
  create: z.union([ z.lazy(() => SubLevelCreateWithoutQuestionsInputSchema),z.lazy(() => SubLevelUncheckedCreateWithoutQuestionsInputSchema) ]),
}).strict();

export const SubLevelUpdateWithoutQuestionsInputSchema: z.ZodType<Prisma.SubLevelUpdateWithoutQuestionsInput> = z.object({
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  cooldownTime: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  playTime: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const ActivityUncheckedUpdateManyWithoutActivitiesInputSchema: z.ZodType<Prisma.ActivityUncheckedUpdateManyWithoutActivitiesInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  activity: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  activity_Date: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const QuestionUpdateWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUpdateWithoutSubLevelInput> = z.object({
  question: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const QuestionUncheckedUpdateWithoutSubLevelInputSchema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutSubLevelInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  question: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const QuestionUncheckedUpdateManyWithoutQuestionsInputSchema: z.ZodType<Prisma.QuestionUncheckedUpdateManyWithoutQuestionsInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  question: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const FragmentUpdateWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUpdateWithoutFragmentgroupInput> = z.object({
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  useAlways: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  notes: z.lazy(() => NoteUpdateManyWithoutFragmentNestedInputSchema).optional(),
...
export const FragmentUncheckedUpdateWithoutFragmentgroupInputSchema: z.ZodType<Prisma.FragmentUncheckedUpdateWithoutFragmentgroupInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  useAlways: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SubLevelUpdateWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUpdateWithoutFragmentGroupsInput> = z.object({
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  cooldownTime: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  playTime: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SubLevelUncheckedUpdateWithoutFragmentGroupsInputSchema: z.ZodType<Prisma.SubLevelUncheckedUpdateWithoutFragmentGroupsInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  cooldownTime: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SceneUncheckedUpdateManyWithoutChosenSceneInputSchema: z.ZodType<Prisma.SceneUncheckedUpdateManyWithoutChosenSceneInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  id_levelResult: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  id_playedFragment: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  chosenFragmentLatency: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SceneUpdateWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUpdateWithoutPlayedFragmentInput> = z.object({
  chosenFragmentLatency: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  answeredCorrectly: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  chosenFragment: z.lazy(() => FragmentUpdateOneWithoutChosenSceneNestedInputSchema).optional(),
  sceneFragments: z.lazy(() => SceneFragmentUpdateManyWithoutSceneNestedInputSchema).optional(),
...
export const SceneUncheckedUpdateWithoutPlayedFragmentInputSchema: z.ZodType<Prisma.SceneUncheckedUpdateWithoutPlayedFragmentInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  id_chosenFragment: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  id_levelResult: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  chosenFragmentLatency: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SceneUncheckedUpdateManyWithoutPlayedSceneInputSchema: z.ZodType<Prisma.SceneUncheckedUpdateManyWithoutPlayedSceneInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  id_chosenFragment: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  id_levelResult: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  chosenFragmentLatency: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const QuestionAnswerFindFirstArgsSchema: z.ZodType<Prisma.QuestionAnswerFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ QuestionAnswerOrderByWithRelationInputSchema.array(),QuestionAnswerOrderByWithRelationInputSchema ]).optional(),
...
export const QuestionAnswerGroupByArgsSchema: z.ZodType<Prisma.QuestionAnswerGroupByArgs> = z.object({
  where: QuestionAnswerWhereInputSchema.optional(),
  orderBy: z.union([ QuestionAnswerOrderByWithAggregationInputSchema.array(),QuestionAnswerOrderByWithAggregationInputSchema ]).optional(),
  by: QuestionAnswerScalarFieldEnumSchema.array(),
