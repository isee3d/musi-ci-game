...
const DownloadPage: NextPage = () => {
  ...
  const usersQuery = api.download.getAllUsers.useQuery(undefined, {enabled: true})
  const levelsQuery = api.download.getAllLevels.useQuery(undefined, {enabled: !!usersQuery.data})
  const sublevelsQuery = api.download.getAllSublevels.useQuery(undefined, {enabled: !!levelsQuery.data})
  const fragmentGroupsQuery = api.download.getAllFragmentGroups.useQuery(undefined, {enabled: !!sublevelsQuery.data})
  const fragmentsQuery = api.download.getAllFragments.useQuery(undefined, {enabled: !!fragmentGroupsQuery.data})
  const notesQuery = api.download.getAllNotes.useQuery(undefined, {enabled: !!fragmentsQuery.data})
  const gameModesQuery = api.download.getAllGameModes.useQuery(undefined, {enabled: !!notesQuery.data})
  const levelResultsQuery = api.download.getAllLevelResults.useQuery(undefined, {enabled: !!gameModesQuery.data})
  const scenesQuery = api.download.getAllScenes.useQuery(undefined, {enabled: !!levelResultsQuery.data})
  const sceneFragmentsQuery = api.download.getAllSceneFragments.useQuery(undefined, {enabled: !!scenesQuery.data})
  const relistenFragmentsQuery = api.download.getAllRelistenFragments.useQuery(undefined, {enabled: !!sceneFragmentsQuery.data})
  const questionAnswersQuery = api.download.getAllQuestionAnswers.useQuery(undefined, {enabled: !!relistenFragmentsQuery.data})
  const activitiesQuery = api.download.getAllActivities.useQuery(undefined, {enabled: !!questionAnswersQuery.data})
