...
const Game: React.FC<GameProps> = ({ gameId, name, description, borderColor }) => {
    ...
    return (
        <Link
            ...
            href={ `/progress/${gameId}`}
        >
        <div className="flex w-full items-center justify-between rounded-lg shadow-md">
            <div className="flex justify-start space-x-4">
                <div className=" flex h-16 w-16 items-center justify-center rounded-lg border-4 text-center text-2xl font-bold text-white" style={ propNumberStyle }>{ gameId }</div>
