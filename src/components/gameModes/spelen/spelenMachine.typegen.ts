...
"TWO": "xstate.after(THREE)#spelen.countdown.3";
        ...
        matchesStates: "CancelledPlayingSpelenMode" | "FinishedPlayingSpelenMode" | "countdown" | "countdown.1" | "countdown.2" | "countdown.3" | "countdown.GO!" | "idle" | "playing" | "playing.guessHeardFragment" | "playing.initializePlaying" | "playing.listenToFragments" | "playing.playSound" | "startRound" | { "countdown"?: "1" | "2" | "3" | "GO!";
