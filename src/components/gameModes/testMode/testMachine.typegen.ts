...
"TWO": "xstate.after(THREE)#testMode.countdown.3";
        ...
        matchesStates: "FinishedPlayingTestMode" | "countdown" | "countdown.1" | "countdown.2" | "countdown.3" | "countdown.GO!" | "idle" | "pausedGame" | "playing" | "playing.guessHeardFragment" | "playing.initializePlaying" | "playing.playSound" | "playing.restAfterAnswering" | "startRound" | { "countdown"?: "1" | "2" | "3" | "GO!";
