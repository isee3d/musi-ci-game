...
"TWO": "xstate.after(THREE)#spelen.countdown.3";
        ...
        matchesStates: "FinishedPlayingUitdagingMode" | "countdown" | "countdown.1" | "countdown.2" | "countdown.3" | "countdown.GO!" | "idle" | "playing" | "playing.guessHeardFragment" | "playing.initializePlaying" | "playing.playSound" | "playing.restAfterAnswering" | "startRound" | { "countdown"?: "1" | "2" | "3" | "GO!";
