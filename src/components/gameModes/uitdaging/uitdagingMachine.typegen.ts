  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "xstate.after(1000)#spelen.playing.restAfterAnswering": { type: "xstate.after(1000)#spelen.playing.restAfterAnswering" };
...
"onCountdownEnded": "EXITGAME" | "FINISHEDPLAYING" | "RESTARTMACHINE" | "xstate.after(GO)#spelen.countdown.GO!" | "xstate.stop";
...
"TWO": "xstate.after(THREE)#spelen.countdown.3";
        ...
        matchesStates: "ExitGame" | "FinishedPlayingUitdagingMode" | "countdown" | "countdown.1" | "countdown.2" | "countdown.3" | "countdown.GO!" | "idle" | "playing" | "playing.guessHeardFragment" | "playing.initializePlaying" | "playing.playSound" | "playing.restAfterAnswering" | "startRound" | { "countdown"?: "1" | "2" | "3" | "GO!";
