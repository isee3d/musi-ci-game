...
const UpdateFragmentModal: React.FC<BaseStaticModalProps> = ({ setmodal, fragment }) => {
    ...
    const notesOfFragmentQuery = api.fragmentNote.getNotesOfFragment.useQuery({ id: fragment.id },
                        ...
                        <div className="relative flex flex-col justify-center p-6">
                            <form onSubmit={ handleSubmit(onSubmit) }>
                                <div className="grid w-full gap-6 md:grid-cols-2">
                                    ...
                                    <div>
                                        <label className="mb-2 block text-sm font-medium text-gray-900 ">Luister fragment</label>
                                        <button className="rounded-xl bg-blue-500 p-4  hover:bg-white/20 ">
                                            Luister naar fragment
                                        </button>
                                    </div>
                                    <div>
                                        <label className="mb-2 block text-sm font-medium text-gray-900 ">Omschrijving</label>
                                        <textarea
